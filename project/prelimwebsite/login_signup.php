...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['register'])) {
    ...
    // New validation for username: no spaces and first character must be a letter
    elseif (preg_match('/\s/', $username)) {
        $error = "Username cannot contain spaces";
        $active_form = 'register';
    } elseif (!preg_match('/^[a-zA-Z]/', $username)) {
        $error = "Username must start with a letter (A-Z or a-z)";
        $active_form = 'register';
    }
    // New validation for password: must contain at least one uppercase, one lowercase, and one special character
