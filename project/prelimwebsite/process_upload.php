...
$sql = "INSERT INTO Resources (User_id, Course_name, Resource_type, University_name, Subject_name, Title, Description, File_type, Upload_date, file_path, approval_status) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
if ($stmt->execute()) {
    ...
    sendResponse(true, 'Resource uploaded successfully! It will be visible after admin approval.');
} else {
    // Delete uploaded file if database insert fails
    unlink($upload_path);
