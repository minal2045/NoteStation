...
$conditions = ["r.approval_status = 'approved'"]; // Only show approved resources
$params = [];
$types = "";
...
// Get unique courses for filter dropdown (only from approved resources)
...
// Get universities based on current filter type for dropdown (only for question papers)
...
// Get statistics (only from approved resources)
$stats_sql = "SELECT 
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if ($is_logged_in): ?>
                        <!-- Only show Upload and My Uploads if user is NOT an admin -->
                        <?php if (!$is_admin): ?>
                            <li class="nav-item">
        ...
        <div class="filter-section">
            ...
            <form method="GET" action="homepage.php" id="filterForm">
                ...
                <div class="filter-group">
                    ...
                    <!-- University Dropdown - Only visible when question papers are selected -->
    ...
    $(document).ready(function() {
        ...
        // Show/hide university dropdown based on selected filter type
        $('.filter-btn').click(function() {
            ...
            if (type === 'question_paper') {
                ...
                // Clear university value when hiding
