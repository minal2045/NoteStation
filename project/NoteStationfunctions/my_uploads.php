...
<head>
    ...
    <style>
        ...
        .header-buttons .btn-upload:hover {
            transform: translateY(-2px);
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <div class="header-buttons">
                        <a href="homepage.php" class="btn btn-home">
                            <i class="fas fa-home me-2"></i>Home
                        </a>
                        <a href="upload_form.php" class="btn btn-upload">
    ...
    <div class="container">
        ...
        <div class="resources-grid" id="gridView">
            ...
            <div class="resource-card" 
                ...
                <div class="card-body">
                    <!-- Add this inside the card-body, before the description -->
                    <div class="mb-2">
                        <?php 
                        $status_class = '';
                        $status_text = '';
                        ...
                        <span class="badge bg-<?php echo $status_class; ?>">
                            <i class="fas fa-<?php echo $status_class == 'success' ? 'check-circle' : ($status_class == 'warning' ? 'clock' : 'exclamation-circle'); ?> me-1"></i>
                            <?php echo $status_text; ?>
                        </span>
                        <?php if ($row['approval_status'] == 'pending'): ?>
                            <small class="text-muted ms-2">(Awaiting admin review)</small>
                        <?php elseif ($row['approval_status'] == 'rejected'): ?>
                            <small class="text-muted ms-2">(Not approved for public view)</small>
                        <?php endif; ?>
                    </div>
...
$(document).ready(function() {
    ...
    // Update view-resource buttons to be disabled for DOCX/PPT
