...
<head>
    ...
    <style>
        ...
        /* Toast message - matches login_signup.php style */
        .message {
            position: fixed;
            top: 20px;
            left: 50%;
...
<body>
        ...
        <div class="container">
            ...
            <div class="filter-section">
                ...
                <form method="GET" action="homepage.php" id="filterForm">
                    ...
                    <?php endif; ?>
                    <!-- Hidden inputs for type and rating -->
                    ...
                    <div class="filter-btns">
                        ...
                        <a href="homepage.php" class="filter-btn clear-filters-btn">
                    ...
                    <div class="row g-3">
                        <div class="col-md-3">
                            <select name="course" class="filter-select" onchange="saveScrollAndSubmit(this.form)">
                        ...
                        <div class="col-md-3">
                            <select name="subject" class="filter-select" onchange="saveScrollAndSubmit(this.form)">
                        ...
                        <div class="col-md-3" id="universityCol" style="<?php echo $show_university_col ? '' : 'display:none;'; ?>">
                            <select name="university" class="filter-select" id="universityDropdown" onchange="saveScrollAndSubmit(this.form)">
            ...
            <div class="modal-content">
                <div class="modal-body login-prompt">
                    ...
                    <div class="login-buttons">
                        <a href="login_signup.php?form=login" class="btn btn-login">
                            Login
                        </a>
                        <a href="login_signup.php?form=register" class="btn btn-signup">
                            Sign Up
                        </a>
                    </div>
                </div>
    ...
    // Save scroll then submit the form
    function saveScrollAndSubmit(form) {
        saveScroll();
        form.submit();
    }

    // Update hidden type input, save scroll, then submit — used by type buttons
    function setTypeAndSubmit(type) {
        document.getElementById('typeInput').value = type;
        // Clear university when switching type to avoid stale filter
        var uniSelect = document.getElementById('universityDropdown');
        if (uniSelect) uniSelect.value = '';
        saveScrollAndSubmit(document.getElementById('filterForm'));
    }

    // Restore scroll after page load
    ...
    $(document).ready(function() {
        ...
        // Toast notification helper - matches login_signup.php style
        ...
        // Star rating filter initialization
        ...
        // Click star → update hidden input and submit
        ...
        <?php if ($is_logged_in && !$is_admin): ?>
        // Rating star functionality in modal
        ...
        // Disable eye icon for unsupported file types
        ...
        // University dropdown visibility on type change
        ...
        // Check URL for login/logout success messages
        (function() {
