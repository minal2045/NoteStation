...
<body>
    ...
    <div class="container">
        ...
        <!-- ── Pending approvals inline notice (not a popup) ── -->
        <?php if ($stats['pending'] > 0): ?>
        <div class="message warning" id="pendingNotice" style="
            position: static;
            transform: none;
            left: auto;
            top: auto;
        ...
        ">
            ...
            <button class="btn-view-pending ms-3" onclick="document.getElementById('resources-tab').click(); filterPending();">
                View Pending
            </button>
        </div>
        <?php endif; ?>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="ratings">
                <div class="table-container">
                    ...
                    <!-- ── Ratings info notice (inline, not a popup) ── -->
    ...
    $(document).ready(function() {
        ...
        // ── Auto-hide flash message after 3 seconds (matching login_signup.php behaviour) ──
